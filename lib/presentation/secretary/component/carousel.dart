...
import 'package:tlbisibida_doc/presentation/secretary/component/bottom_action_buttons_sec.dart';
...
class _CarouselWithIndicatorState extends State<CarouselWithIndicatorDemo> {
  ...
  Widget build(BuildContext context) {
    ...
    final List<Widget> imageSliders = cubit.sec
                            ...
                            child: Container(
                              ...
                              child: Column(
                                children: [
                                          ...
                                          child: Padding(
                                            ...
                                            child: Row(
                                              ...
                                              children: [
                                                IconButton(
                                                    onPressed: () {
                                                      secretaryAttendenceTimeController
                                                          .text = 'day';
                                                    },
                                                    icon: Icon(
                                                      CupertinoIcons
                                  ...
                                  bottomActionButtonsSec(context, item.id!),
                                ],
                              ),
                            ),
                          ),
    ...
    return Scaffold(
      body: Column(children: [
        ...
        Row(
          ...
          children: cubit.sec.asMap().entries.map((entry) {
