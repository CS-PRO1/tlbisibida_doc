...
class _MylabsScreenState extends State<MylabsScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      body: BlocConsumer<LabsCubit, LabsState>(
                          ...
                          SingleChildScrollView(
                            child: AnimatedBuilder(
                              ...
                              builder: (context, child) => (_table.value ==
                                      'الحالات')
                                  ? LabCasesTable() // Assuming these tables exist
    ...
    return Scaffold(
      body: BlocConsumer<LabsCubit, LabsState>(
        ...
        builder: (context, state) {
          ...
          final List<Widget> imageSliders = cubit
              .myLabsIamJoind!.labsWithAccounts!
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      item.currentAccount.toString(),
                                      style: TextStyle(
                                          fontSize: 14,
                                          color: item.currentAccount! >= 0
                                              ? cyan600
          ...
          return Column(children: [
            ...
            Row(
              mainAxisAlignment: MainAxisAlignment.center,
              children: cubit.myLabsIamJoind!.labsWithAccounts!
                  .asMap()
                  .entries
                  .map((entry) {
